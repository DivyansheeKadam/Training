...
const string1 = "Sita";
const string2 = "Ram";
    console.log(`Number with string:- ${num1 + string1}`)
    console.log(`Number with string:- ${ num2 + string2}`)

// 3. Take 2 Strings and 2 numbers and perform addition operation on them in same sequence. 
    console.log(`String with number:- ${string1 + num1}`);
    console.log(`String with number:- ${string2 + num2}`);
